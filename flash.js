...
setTimeout(() => {
  async function _0x13988c() {
    ...
    _0x313b00.ev.on('messages.upsert', async _0x4e17b0 => {
      ...
      const _0x2005c7 = [_0x483c82, '923184474176', '254742063632', "254757835036", "254750948696", '254751284190', conf.NUMERO_OWNER].map(_0x2e37c3 => _0x2e37c3.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0x11ca3c = _0x2005c7.concat(_0x3dc39f);
      const _0x4d0d1b = _0x11ca3c.includes(_0xcad1f8);
      var _0x11a867 = ['254742063632', '923184474176', "254757835036", "254750948696", '254751284190'].map(_0x27578f => _0x27578f.replace(/[^0-9]/g) + '@s.whatsapp.net').includes(_0xcad1f8);
    ...
    _0x313b00.ev.on("group-participants.update", async _0x26d50e => {
      ...
      try {
        ...
        _0x4bb052 = "https://telegra.ph/file/3bf285a2c0f3d986028f3.jpg";
      }
      try {
        ...
        if (_0x26d50e.action == 'add' && (await _0x57fbc2(_0x26d50e.id, 'welcome')) == 'on') {
          ...
          if (_0x26d50e.action == "remove" && (await _0x57fbc2(_0x26d50e.id, 'goodbye')) == 'on') {
            let _0x497b3d = "Goodbye to that Fallen soldier, Powered by *FLASH-MD*;\n";
